...
export  function showCurrentAttacks( power ) {

    console.log("🔥 Fire Attacks 🔥");

    attacksByPower[power].forEach(attack => {
        ...
        for (let creature in attack.damage) {
            ...
            const attackMsg = `🗡️ ${attack.name} make ${attack.damage[creature]} damage point on its enemy within this attack! 🔥❄️`;
...
const thisPower = "Swamp";

// Llamamos a la función
showCurrentAttacks( thisPower );

// 🔥❄️ Funtion to get the Damage that make an specific creature
export function getDamageByAttack(creatureName, attackName) {
        ...
        for (let attack of attacksByPower[category]) {
            ...
            if (attack.name === attackName) {
                ...
                if (creatureName in attack.damage) {
                    ...
                    const currentDamage = attack.damage[creatureName];
...
console.log(getDamageByAttack("IceDragon", "Snow Ball")); 

console.log(getDamageByAttack("Phoenix", "Fire Ball")); 

console.log(getDamageByAttack("Sphinx", "Fire Breath")); 

console.log(getDamageByAttack("Dragon", "Fire Claw")); 
